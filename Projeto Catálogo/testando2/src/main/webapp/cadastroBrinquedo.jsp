...
<h2></h2>
    <form action="./ServletCatalogo" method="post" enctype="multipart/form-data" class="centered-form" onsubmit="return validarForm();">
        ...
        <div id="inserir">
            ...
            <input type="text" name="txtNome" size="60" maxlength="50"  /><br><br>
            <select size="1" name="cmbCategoria" >
                <option>Selecione uma Categoria</option>
                <option>Jogos Eletronico</option>
                <option>Brinquedo</option>
                <option>Livros</option>
                <option>Bonecos</option>
            </select><br><br>
            <input type="file" name="txtFoto" size="60" ><br><br>
            <input type="number" name="txtPreco" step="any" size="60" /><br><br>
            ...
            <textarea  type="text" cols="59" rows="7" name="txtDescricao" minlength="5" placeholder="Digite os detalhes do brinquedo"></textarea><br><br>
